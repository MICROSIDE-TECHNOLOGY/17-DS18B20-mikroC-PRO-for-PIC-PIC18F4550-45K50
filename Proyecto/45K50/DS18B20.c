...
//Referencias externas de conexi�n del modulo LCD
...
//  Fin de las referencias externas de conexi�n del modulo LCD

//  18S20: 9  (Configuraci�n por defecto; 9,10,11,o 12)
//  18B20: 12
...
void main() org 0x2000
{
  ...
  //Imprimir car�cter de grado, 'C' para grados cent�grados
  Lcd_Chr(2,13,223);
  Lcd_Chr(2,14,'C');
  
 while(1) {

    Ow_Reset(&PORTA, 0);                     // Se�al de reinicio Onewire
